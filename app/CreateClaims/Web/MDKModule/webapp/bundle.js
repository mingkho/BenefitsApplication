...
function DeleteConfirmation(clientAPI) {
    return clientAPI.executeAction('/CreateClaims/Actions/DeleteConfirmation.action').then((result) => {
        if (result.data) {
            return clientAPI.executeAction('/CreateClaims/Actions/Claims/Claims_DeleteEntity.action').then(
...
function DeleteConfirmation(clientAPI) {
    return clientAPI.executeAction('/CreateClaims/Actions/DeleteConfirmation.action').then((result) => {
        if (result.data) {
            return clientAPI.executeAction('/CreateClaims/Actions/Receipts/Receipts_DeleteEntity.action').then(
                (success) => Promise.resolve(success),
                (failure) => Promise.reject('Delete entity failed ' + failure));
        } else {
            return Promise.reject('User Deferred');
...
/***/ "./build.definitions/CreateClaims/Styles/Styles.json":
/*!***********************************************************!*\
  !*** ./build.definitions/CreateClaims/Styles/Styles.json ***!
  \***********************************************************/
/***/ ((module) => {
...
let createclaims_styles_styles_json = __webpack_require__(/*! ./CreateClaims/Styles/Styles.json */ "./build.definitions/CreateClaims/Styles/Styles.json")
...
let createclaims_styles_styles_nss = __webpack_require__(/*! ./CreateClaims/Styles/Styles.nss */ "./build.definitions/CreateClaims/Styles/Styles.nss")
...
module.exports = {
	...
	createclaims_styles_styles_json : createclaims_styles_styles_json,
	createclaims_styles_styles_less : createclaims_styles_styles_less,
	createclaims_styles_styles_nss : createclaims_styles_styles_nss,
...
/***/ "./build.definitions/CreateClaims/Styles/Styles.nss":
/*!**********************************************************!*\
  !*** ./build.definitions/CreateClaims/Styles/Styles.nss ***!
  \**********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
module.exports = {"DestinationName":"../service/BenefitsApplication/","OfflineEnabled":false,"LanguageURLParam":"","OnlineOptions":{},"PathSuffix":"","SourceType":"Cloud","ServiceUrl":""}
